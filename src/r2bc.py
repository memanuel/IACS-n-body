...
Restricted Two Body Problem - Circular Orbits
...
# ********************************************************************************************************************* 
class KineticEnergy_R2BC(keras.layers.Layer):
...
# ********************************************************************************************************************* 
class PotentialEnergy_R2BC(keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        tf.debugging.assert_shapes(shapes={
            ...
            mu: (batch_size, 1)
        }, message='PotentialEnergy_R2BC / inputs')
        ...
        }, message='PotentialEnergy_R2BC / outputs')
...
# ********************************************************************************************************************* 
class AngularMomentum0_R2BC(keras.layers.Layer):
...
# ********************************************************************************************************************* 
class AngularMomentum_R2BC(keras.layers.Layer):
...
class ConfigToPolar2D(keras.layers.Layer):
    def call(self, inputs):
        ...
        L0 = AngularMomentum0_R2BC(name='ang_mom')([q0, v0])
...
class Motion_R2BC(keras.Model):
    ...
    def __init__(self, position_model, **kwargs):
        super(Motion_R2BC, self).__init__(**kwargs)
